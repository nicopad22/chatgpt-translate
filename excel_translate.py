...
def translate_excel(root, file, outfile, translator):
    # Load the workbook
    workbook = openpyxl.load_workbook(root + file)

    # Create a new workbook for the output
    output_workbook = openpyxl.load_workbook(root + outfile)

    # Iterate through each sheet
    for sheet_name in workbook.sheetnames:
        translate_sheet(workbook, output_workbook, sheet_name, translator)
        output_workbook[sheet_name].title = translator(sheet_name)
